...
export class VisualizerEngine {
  ...
  async initialize() {
    ...
    const storedVisualization = state?.visualization || {};
    const storedParameters = storedVisualization.parameters || {};
    const storedSystem = storedVisualization.activeSystem;

    this.currentParameters = { ...storedParameters };
    const initialSystem = restored && storedSystem ? storedSystem : 'faceted';
