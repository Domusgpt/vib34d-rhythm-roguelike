...
export class MobileOptimizationManager {
    constructor({ canvas, visualizer, parameterManager, audioService, startScreen, onPreferenceChanged, onProfileApplied }) {
        this.canvas = canvas;
        ...
        this.onProfileApplied = onProfileApplied;
